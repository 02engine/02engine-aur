...
# Contributor: LuoTianyi_arm64 <2153585992@qq.com>
...
source=(".INSTALL::https://github.com/02engine/02engine-aur/releases/download/INSTALL/INSTALL"
        "02engine-${pkgver}.deb"::"https://github.com/02engine/desktop/releases/download/v${pkgver}/02Engine-linux-amd64-${pkgver}.deb")
...
depends=('alsa-lib' 'at-spi2-atk' 'at-spi2-core' 'cairo' 'dbus' 'expat' 'gcc-libs' 'glib2' 'glibc' 
         'gtk3' 'hicolor-icon-theme' 'libcups' 'libnotify' 'libsecret' 'libx11' 'libxcb' 
         'libxcomposite' 'libxdamage' 'libxext' 'libxfixes' 'libxkbcommon' 'libxrandr' 
         'libxss' 'libxtst' 'mesa' 'nspr' 'nss' 'pango' 'systemd-libs' 'util-linux-libs' 
